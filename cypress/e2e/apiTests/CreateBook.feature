Feature: Create a book
  ...
  Scenario: Attempt to create a book without request body
   ...
   Scenario: Attempt to create a book without mandatory title field
     Given the API endpoint is ready
     When the user sends a POST request without title to create a book
     Then the response should be bad request

  Scenario: Attempt to create a book without mandatory author field
    Given the API endpoint is ready
    When the user sends a POST request without author to create a book
    Then the response should be bad request

  Scenario: Attempt to create a book with numeric value for author
    Given the API endpoint is ready
